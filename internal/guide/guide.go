...
var All = []Guide{
	...
	},
	{
		...
		Steps: []Step{
			...
			},
			{
				...
				Action:  "Run /skill ls to see skills loaded from your plugins.",
				Command: "/skill",
				XP:      15,
				Hint:    "Skills are AI workflows from your plugins. Install more with /plugin install.",
			},
		},
	},
	{
...

	{
		...
		Steps: []Step{
			...
			},
			{
				...
				Action:  "Run /skill ls to see skills added by the plugin.",
				Command: "/skill ls",
				XP:      15,
				Hint:    "Skills are grouped by category. New plugin skills appear at the bottom.",
			},
		},
	},

	{
		...
		Short: "Explore, fetch, and inspect skills",
		Steps: []Step{
			{
				Title:   "Browse skill tags",
				Action:  "Run /skill tags to see all categories in the content-addressable store.",
				Command: "/skill tags",
				XP:      15,
				Hint:    "Tags map to SKILL.md categories. Each tag resolves to a CAS hash.",
			},
			{
				Title:   "Fetch a skill by name",
				Action:  "Run /skill get <name> to retrieve a skill's full content.",
				Command: "/skill get",
				XP:      20,
				Hint:    "The content comes from the CAS on the gateway — not from local plugin files.",
			},
			{
				...
				XP:      20,
				Hint:    "CAS hashes are stable — they're how the gateway deduplicates and versions skills.",
			},
		},
	},
